...
layui.use(['elements', 'jquery', 'layer', 'larry', 'navtab', 'form', 'common'],
    function() {
        var $ = layui.jquery,
            layer = layui.layer,
            device = layui.device(),
            ...
            $menu.find('li.layui-nav-item').each(function() {
                ...
                $that.on('click',
                    function() {
                        ...
                        if (id == 40) result = pid_40;
                        // if (id == 46) result = pid_46;
